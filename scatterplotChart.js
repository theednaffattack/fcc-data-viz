...
let { data: local_scatterplot_data } = [
  {
    Time: "36:50",
    Place: 1,
    Seconds: 2210,
...
const min = d3.min(local_scatterplot_data, d => d[1]);
const max = d3.max(local_scatterplot_data, d => d)[1];

// extent should give the min and max of our data set
const extent = d3.extent(local_scatterplot_data, d => d[1]);
...
const yExtent = d3.extent(local_scatterplot_data, d => d[1]);
...
//   .attr("id", "tooltip-scatterplot")
//   // .attr("data-date", d => d)
//   .offset([-10, 0])
//   .html(d => {
//     let formatNumber = d3.format(",.0f");
//     d3.select("#tooltip-scatterplot").attr("data-date", d[0]);
//     return (
